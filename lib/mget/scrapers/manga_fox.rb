...
module MangaGet
    ...
    # Subclass of {MangaGet::Scraper Scraper} that targets mangafox.me
    class MangaFoxScraper < Scraper
        ...
        PAGE_MAX_XPATH = '//*[@id="top_bar"]/div/div/text()[2]'
        # xpath for the list of all chapters on the series home
        CHAPTER_SELECT_XPATH = '//ul[@class="chlist"]//h3/a |
                                //ul[@class="chlist"]//h4/a'
        # xpath to the warning put on mangafox pages for licensed manga
        MANGA_LICENSED_XPATH = '//div[@class="warning"]' 
